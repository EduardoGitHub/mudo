...
// +--------------------------------------------------------------------------------------+
  ...
  define('MODULE_PAYMENT_BOLETOREAL_TEXT_TITLE', 'Boleto Bancário Banco do Real');
  define('MODULE_PAYMENT_BOLETOREAL_TEXT_DESCRIPTION', 'Geração de Boleto Bancário Real<br>');
?>
