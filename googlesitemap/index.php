 ...
 */
	 ...
	 */
	define('GOOGLE_XML_SITEMAP_SHOW_DIAGNOSTIC', 'true');
	define('GOOGLE_XML_SITEMAP_SEO', 'Standard');
	define('GOOGLE_XML_SITEMAP_CREATE_SPECIALS', 'true');
	define('GOOGLE_XML_SITEMAP_CREATE_MANU', 'true');
