 ...
 */
  ...
  function kgt_draw_type_drop_down( $type = 'discount', $name = '', $default = '', $params = '' ) {
    if( $type == 'discount' ) {
      $values = array( array( 'id' => 'fixed', 'text' => 'Valor fixo' ),
                       array( 'id' => 'percent', 'text' => 'Percentagem de desconto' ),
                       array( 'id' => 'shipping', 'text' => 'Desconto de envio' ) );
    } else if( $type == 'min_order' ) {
      $values = array( array( 'id' => 'price', 'text' => 'Preço Total' ),
                       array( 'id' => 'quantity', 'text' => 'Quantidade de Produtos' ) );
    }
