 ...
 ?>
			...
			<div class="ct-page box margin-25t bt-5px b-shadow clearfix">
		        ...
		        <div class="span12 button-blog">
			        ...
			        <?php else : ?>
			          <h1 class="entry-title" style="margin-bottom:0;"><?php _e( 'Posts by Category: ' , 'color-theme-framework' ); ?><?php echo single_cat_title('', false); ?></h1>
			        <?php endif; ?>
			  		<span style="color: #888;font-style: italic;"><?php echo category_description(); ?></span>
		    	  </div> <!-- category-title -->
