...
define('HEADING_TITLE', 'Gerenciador de Parceiros');

define('TABLE_HEADING_BANNERS', 'Parceiros');
define('TABLE_HEADING_GROUPS', 'Grupos');
define('TABLE_HEADING_STATISTICS', 'Vistos / Clicados');
define('TABLE_HEADING_STATUS', 'Status');
define('TABLE_HEADING_ACTION', 'Ação');
define('TEXT_BANNERS_TITLE', 'Nome do parceiro:');
define('TEXT_BANNERS_URL', 'URL do parceiro:');
define('TEXT_BANNERS_GROUP', 'Grupo do parceiro:');
define('TEXT_BANNERS_NEW_GROUP', ', ou entre com um novo grupo de parceiro abaixo');
define('TEXT_BANNERS_IMAGE', 'Logomarca/banner do parceiro:');
define('TEXT_BANNERS_IMAGE_LOCAL', ', ou entre com o arquivo local abaixo. (<b>Obs.:</b> Dimensão maxima da largura da logomarca/banner é de 159px;)');
...
define('TEXT_BANNERS_BANNER_VIEWS', 'Parceiros Vistos');
define('TEXT_BANNERS_BANNER_CLICKS', 'Parceiros Clicados');

define('TEXT_INFO_DELETE_INTRO', 'Tem certeza que quer deletar este parceiro?');
define('TEXT_INFO_DELETE_IMAGE', 'Deletar a logomarca/banner do parceiro');

define('SUCCESS_BANNER_INSERTED','Sucesso: O parceiros foi inserido.');
define('SUCCESS_BANNER_UPDATED', 'Sucesso: O parceiros foi atualizado.');
define('SUCCESS_BANNER_REMOVED', 'Sucesso: O parceiros foi removido.');
define('SUCCESS_BANNER_STATUS_UPDATED', 'Sucesso: O status do parceiro foi atualizado.');

define('ERROR_BANNER_TITLE_REQUIRED', 'Erro: Título do Parceiro requerido.');
define('ERROR_BANNER_GROUP_REQUIRED', 'Erro: Grupo do Parceiro requerido.');
