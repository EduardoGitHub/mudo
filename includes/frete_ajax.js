...
function Checacep(destino,peso,valor,qtd,comprimento, largura, altura, diametro) 
{ 
//FUNÇÃO QUE MONTA A URL E CHAMA A FUNÇÃO AJAX 
url="frete_calculo.php?destino="+destino+"&peso="+peso+"&valor="+valor+"&qtd="+qtd+"&comprimento="+comprimento+"&largura="+largura+"&altura="+altura+"&diametro="+diametro; 
ajax(url); 
} 
