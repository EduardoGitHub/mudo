...
$dadosboleto["nosso_numero"] = $_POST["nosso_numero"];  // Nosso numero sem o DV - REGRA: Máximo de 11 caracteres!
...
$dadosboleto["conta_cedente"] = $_POST["conta"]; // ContaCedente do Cliente, sem digito (Somente Números)
$dadosboleto["conta_cedente_dv"] = $_POST["contadv"]; // Digito da ContaCedente do Cliente
$dadosboleto["carteira"] = $_POST["carteira"]; // Código da Carteira 06
