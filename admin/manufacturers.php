...
<?php
  ...
  switch ($action) {
    case 'new':
      ...
      /*** Begin Header Tags SEO ***/
      $contents[] = array('text' => '<br>' . 'Titulo tags (SEO)' . $manufacturer_htc_title_string);
      $contents[] = array('text' => '<br>' . 'Descrição tags (SEO)' . $manufacturer_htc_desc_string);
      $contents[] = array('text' => '<br>' . 'Palavras-chaves (SEO)' . $manufacturer_htc_keywords_string);
      $contents[] = array('text' => '<br>' . 'Descrição detalhada (SEO)' . $manufacturer_htc_description_string);
      /*** End Header Tags SEO ***/
    ...
    case 'edit':
      ...
      $contents[] = array('text' => '<br>' . TEXT_MANUFACTURERS_URL . $manufacturer_inputs_string);
	  /*** Begin Header Tags SEO ***/
      $contents[] = array('text' => '<br>' . 'Titulo (SEO)' . $manufacturer_htc_title_string);
      $contents[] = array('text' => '<br>' . 'Descrição (SEO)' . $manufacturer_htc_desc_string);
      $contents[] = array('text' => '<br>' . 'Palavras-chaves (SEO)' . $manufacturer_htc_keywords_string);
      $contents[] = array('text' => '<br>' . 'Descrição detalhada (SEO)' . $manufacturer_htc_description_string);
      /*** End Header Tags SEO ***/
