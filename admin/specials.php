...
function specials_enhanced_get_all_products(&$products_split, &$products_query_numrows)
{
	...
	$fields = 'p.products_id, p.products_price, p.products_tax_class_id, p.products_model, pd.products_name, s.specials_id, s.specials_new_products_price, s.expires_date, s.status';
...
function specials_enhanced_update_product($product_id, $discount = null, $discount_percent = false, $date = null)
{
	...
	if(tep_db_num_rows(tep_db_query("SELECT specials_id FROM " . TABLE_SPECIALS . " WHERE products_id = $product_id")) == 1)
	{
		$set_fields = array();
										...
										<td valign="top">
											<table border="0" width="100%" cellspacing="0" cellpadding="2">
												<tr class="dataTableHeadingRow">
													<td width="15%" class="dataTableHeadingContent">Código</td>
												...
												<tr class="dataTableRow" onMouseOver="rowOverEffect(this)" onMouseOut="rowOutEffect(this)">
													<td colspan="8">
														<form>
															...
															<table width="100%">
																<tr>
																	<td width="10%" class="dataTableContent"><?php echo $specials['products_id']; ?></td>
