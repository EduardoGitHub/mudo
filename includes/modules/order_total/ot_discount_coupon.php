      ...
      if( is_object( $order->coupon ) ) {
        ...
        if( is_array( $discount_lines ) ) foreach( $discount_lines as $tax_group => $discount ) {
          if( $discount > 0 ) {
           ...
           /* echo "<script type='text/javascript'>alert('".$tax_group."')</script>";*/
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . "
                      ...
                      ('Ordem de exibição',
                       'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_SORT_ORDER',
                       '0',
                       'Ordem em que o cupom de desconto será exibido na confirmação da compra, facturas, etc.',
                       '615',
                       '2',
                       '',
                       now()),
                      ('Mostrar desconto com sinal menos (-)?',
                       'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_DISPLAY_TYPE',
                       'true',
                       '<b>true</b> - O desconto será exibido com um sinal de menos<br><b>false</b> - O desconto será exibida sem um sinal de menos',
                       '615',
                       '3',
                       'tep_cfg_select_option(array(\'true\', \'false\'), ',
                       now()),
                      ('Mostrar Subtotal com desconto aplicado?',
                       'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_DISPLAY_SUBTOTAL',
                       'true',
                       '<b>true</b> - O subtotal do pedido será exibida com o desconto aplicado<br><b>false</b> - O subtotal do pedido será exibida sem o desconto aplicado',
                       '615',
                       '4',
                       'tep_cfg_select_option(array(\'true\', \'false\'), ',
                       now()),
                      ('Mostrar taxa em consonância com desconto?',
                       'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_DISPLAY_TAX',
                       'None',
                       'Selecione o método para exibir fiscal na linha de desconto',
                       '615',
                       '5',
                       'tep_cfg_select_option(array(\'Nenhum\', \'Mostrar taxa de descontos em linha separada\', \'Display com desconto de imposto aplicada\'), ',
                       now()),
                      ('Excluir produtos em promoção?',
                       'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_EXCLUDE_SPECIALS',
                       'true',
                       '<b>true</b> - produtos em promoção serão excluídos os descontos<br><b>false</b> - produtos em promoção não serão excluídos de descontos',
                       '615',
                       '6',
                       'tep_cfg_select_option(array(\'true\', \'false\'), ',
                       now()),
                      ('Código Aleatório',
                       'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_RANDOM_CODE_LENGTH',
                       '6',
                       'Gerar código do cupom aleatóriamente',
                       '615',
                       '7',
                       '',
                       now()),
                      ('Mostrar desconto total de linhas para cada grupo de imposto?',
                       'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_DISPLAY_LINES',
                       'false',
                       '<b>true</b> - Na pagina de confirmação do pedido o cupom de desconto será mostrado p/ cada grupo de imposto no pedido<br><b>false</b> - Na pagina de confirmação do pedido irá juntar todos os cupons de desconto e irá mostrar somente em uma linha',
                       '615',
                       '8',
                       'tep_cfg_select_option(array(\'true\', \'false\'), ',
                       now()),
                      ('Permitir total do pedido negativo?',
                        'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_ALLOW_NEGATIVE',
                        'false',
                        'Defina como true se você quer que no total da compra do pedido fique negativo quando o desconto for maior que o preço do produto.',
                        '615',
                        '9',
                        'tep_cfg_select_option(array(\'true\', \'false\'), ',
                        now()),
                       ('Use o arquivo de idioma para exibição string formato?',
                        'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_USE_LANGUAGE_FILE',
                        'false',
                        '<b>true</b> - utilizar o formato encontrado no arquivo de idioma (usado para quando você tem várias línguas e deseja que a linha total da ordem de exibição formato dependendo da escolha de linguagem)<br><b>false</b> - utilizar o formato e linguagem definido no sistema',
                        '615',
                        '10',
                        'tep_cfg_select_option(array(\'true\', \'false\'), ',
                        now()),
                       ('Formato de exibição para confirmação da compra',
                        'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_DISPLAY_CONFIG',
                        'Cupon de Desconto de [tax_desc] ',
                        'Mostrar o tipo de formato que você quer que aparece para o cliente.<br><br>Possibilidades:<br>[code]<br>[coupon_desc]<br>[discount_amount]<br>[min_order]<br>[number_available]<br>[tax_desc]',
                        '615',
                        '11',
                        '',
                        now()),
                       ('Modo de debug',
                        'MODULE_ORDER_TOTAL_DISCOUNT_COUPON_DEBUG',
                        'false',
                        'Para uso do desenvolvedor do site. <b>Deve ficar em false quando a loja estiver em produção.</b>',
                        '615',
                        '12',
                        'tep_cfg_select_option(array(\'true\', \'false\'), ',
                        now())");
