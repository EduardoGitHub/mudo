...
// load all enabled shipping modules
  ...
  if ( defined('MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING') && (MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING == 'true') ) {
	...
	*/
	//Verifica se o CEP da pessoa que esta comprando esta dentro da faixa de cep que é para ser gratis
            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <tr>
				...
				<?php } if ($free_shipping == true) { ?>
                   ...
                   <? }else if($free_for_total == false && $free_for_cep == true ){//Exibi a mensagem para fretes gratis para região?>
                   	  <tr>
                        <td><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                        <td colspan="2" width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                          <tr>
