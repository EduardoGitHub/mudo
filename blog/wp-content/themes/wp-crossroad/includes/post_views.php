...
/*           array(  
            'label'=> 'Adjust the view of the post',  
            'desc'  => 'Show/Hide post meta information',  
            'id'    => $prefix.'_mb_meta_post_box',  
            'type'  => 'info-box',
        ), 
        ...
        array(  
            'label'=> 'Title',  
            'desc'  => '',
            'id'    => $prefix.'_mb_post_view_title',  
            'type'  => 'select',
            'show' => 'true',
            'options' => $post_view_title,
        ),  

        array(  
            'label'=> 'Date',  
            'desc'  => '',
            'id'    => $prefix.'_mb_post_view_date',  
            'type'  => 'select',
            'show' => 'true',
            'options' => $post_view_date,
        ),

        array(  
            'label'=> 'Likes & Views',  
            'desc'  => '',
            'id'    => $prefix.'_mb_post_view_likeview',  
            'type'  => 'select',
            'show' => 'true',
            'options' => $post_view_likeview,
        ),

        array(  
            'label'=> 'Category & Read more',  
            'desc'  => '',
            'id'    => $prefix.'_mb_post_view_category',  
            'type'  => 'select',
            'show' => 'true',
            'options' => $post_view_category,
        ), */
        ...
        array(  
            'label'=> 'Type of Video Thumb',  
            'desc'  => 'Choose the type of thumbnail : auto generated from video service or use featured image',  
           ...
           array(  
            'label'=> 'Audio Format',  
            'desc'  => 'Paste embed code from Sound Cloud service',  
