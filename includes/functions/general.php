...
//////////////////////////////////////////////////////////////
/*
FUNÇÃO CONVERTE DATA DE INGLÊS PARA PORTUGUES
...
// função adicionar dias em uma data
...
//                    e.g. info@mytepshop.com
  ...
  function tep_sendMail($to_email_address, $email_subject, $html, $from_email_name, $from_email_address){ //NOVO
	...
	if($email_to){
		...
		$mail->AddAddress($email_to[$cont]);  // coloque aqui o endereço de email que deseja receber as mensagems do formulário de contato.
		}
...
function tep_display_parcela($total) { 
 ...
 function tep_discount_products($products_id){
		...
		$message = 'ou <span>R$'.number_format($discount_values['discount_new_products_price'], 2 , "," , ".").'</span> à vista ';
 ...
 function tep_discount_products_price($products_id, $newprice){
		...
		$message = 'ou <span>R$'.number_format($price, 2 , "," , ".").'</span> à vista ';
		//com <span>' .round($discount_values['discount_percent'],0).'%</span> de desconto
		}
