...
/**
 * Initialization Class for ContactUs.com API (suffix according to plugin _NL)
 * @api
 * @version 0.4
...
class cUsComAPI_NL {
    ...
    public function getAPICredentials($cUs_email, $cUs_pass) {
        ...
        if( $this->_isCurl() ){
            ...
            curl_setopt($ch, CURLOPT_HTTPHEADER, array('X-ContactUs-Request-URL: ' . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'], 'X-ContactUs-Signature: wpnl|1.0.2|' . $this->getIP()));
        ...
        if (!strlen($postData['fname'])) {
            ...
            if( $this->_isCurl() ){
                ...
                curl_setopt($ch, CURLOPT_HTTPHEADER, array(
                    ...
                    'X-ContactUs-Signature: wpnl|1.0.2|' . $this->getIP()
                ));
    ...
    public function getFormKeysData($cUs_API_Account, $cUs_API_Key, $cUs_Form_Type = 'newsletter') {
    ...
    public function resetData() {
        ...
        delete_option('cUsNL_settings_HOME');
