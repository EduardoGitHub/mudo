...
-----------------------------------------------------------------------------------
 	...
 	Plugin Name: CrossRoad Facebook Subscribe Widget
...
add_action('widgets_init','CrossRoad_fbsubscribe_load_widgets');


function CrossRoad_fbsubscribe_load_widgets(){
		register_widget("CrossRoad_fb_subscribe_Widget");
}
...
==========================================================================
*/
class CrossRoad_fb_subscribe_Widget extends WP_widget{

	/* Widget setup. */
	function CrossRoad_fb_subscribe_Widget(){
		
		/* Widget settings. */		
		$widget_ops = array( 'classname' => 'crossroad_subscribe_widget', 'description' => __( 'FB Subscribe Widget' , 'color-theme-framework' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'crossroad_subscribe_widget' );
		
		/* Create the widget. */
		$this->WP_Widget( 'crossroad_subscribe_widget' , __( 'CrossRoad: FB Subscribe' , 'color-theme-framework' ) , $widget_ops, $control_ops );
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
				  ...
				  <div style="border-top: 1px solid #EBECED; padding-top:15px">
