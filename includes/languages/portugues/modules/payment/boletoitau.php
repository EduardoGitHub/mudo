...
// +--------------------------------------------------------------------------------------+
  ...
  define('MODULE_PAYMENT_BOLETOITAU_TEXT_TITLE', 'Boleto Bancário Banco do Itaú');
  define('MODULE_PAYMENT_BOLETOITAU_TEXT_DESCRIPTION', 'Geração de Boleto Bancário Itaú<br>');
?>
