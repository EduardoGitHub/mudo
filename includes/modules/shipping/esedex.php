...
// class methods 
  ...
  { 
    ...
    $this->quotes = array('id' => $this->code, 'module' =>MODULE_SHIPPING_ESEDEX_TEXT_TITLE, 'methods' => array(array('id' => $this->code, 'title' => 'O prazo estimado de produção + entrega para sua região é de '.($frete[1]+5).' dias utéis via E-SEDEX', 'cost'
