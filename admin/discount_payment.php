													...
													<tr>
														<td>
															<table border="0" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                	<td class="main" style="font-weight:bold;" colspan="3">(OBS.: Produtos com <span style="color:#F00;font_weight:bold;">*</span> são produtos que estão na promoção.)</td>
                                                                </tr>
															</table>
														</td>
										...
										<td valign="top">
											<table border="0" width="100%" cellspacing="0" cellpadding="2">
												<tr class="dataTableHeadingRow">
													<td width="5%" class="dataTableHeadingContent">Código</td>
