          ...
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent" width="3%"><?php echo TABLE_HEADING_SELECT; ?></td>
        ...
        if ($rows > 0) {
          if (is_object($cInfo)) { // category info box contents
            ...
            $contents[] = array('text' => '<br>' . 
				...
				tep_image_produto('../'.DIR_WS_IMAGES_PRODUTOS.$pInfo->products_image, $pInfo->products_name, 'YES','P', 'vspace="0"') . '<br>' . $pInfo->products_image);
