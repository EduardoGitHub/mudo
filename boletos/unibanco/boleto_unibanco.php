...
$dadosboleto["nosso_numero"] = $_POST["nosso_numero"];;  // Nosso numero - REGRA: Máximo de 14 caracteres!
$dadosboleto["numero_documento"] = $_POST["nosso_numero"];	// Num do pedido ou do documento
...
$dadosboleto["codigo_cliente"] = $_POST["cod_cliente"]; // Codigo do Cliente
