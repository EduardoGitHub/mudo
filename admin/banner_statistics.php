  ...
  if (function_exists('imagecreate') && ($dir_ok == true) && tep_not_null($banner_extension)) {
    ...
    switch ($type) {
      case 'yearly':
		...
		echo '<br>'.renderChart("includes/charts/includes/FCF_MSLine.swf", "includes/charts/xml/banner_yearly-".$banner_id.".xml", "", "chart1", 900, 400);
        break;
      case 'monthly':
		...
		echo '<br>'.renderChart("includes/charts/includes/FCF_MSLine.swf", "includes/charts/xml/banner_monthly-".$banner_id.".xml", "", "chart2", 900, 400);
        break;
      default:
      case 'daily':
		...
		echo '<br>'.renderChart("includes/charts/includes/FCF_MSLine.swf", "includes/charts/xml/banner_daily-".$banner_id.".xml", "", "chart3", 900, 400);
        break;
    }
?>
