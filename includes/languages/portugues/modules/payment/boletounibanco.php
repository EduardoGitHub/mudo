...
// +--------------------------------------------------------------------------------------+
  ...
  define('MODULE_PAYMENT_BOLETOUNIBANCO_TEXT_TITLE', 'Boleto Bancário Banco do Unibanco');
  define('MODULE_PAYMENT_BOLETOUNIBANCO_TEXT_DESCRIPTION', 'Geração de Boleto Bancário Unibanco<br>');
?>
