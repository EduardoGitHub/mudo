...
// sem certificado HTTP
if(HTTPS_SERVER.DIR_WS_HTTP_CATALOG == ""){

$link = HTTP_CATALOG_SERVER.DIR_WS_ADMIN;
if ($link == "HTTP_CATALOG_SERVERDIR_WS_ADMIN")
{
$link = HTTP_SERVER.DIR_WS_HTTP_CATALOG."";
}

} else { // com certificado HTTPS

$link = HTTPS_CATALOG_SERVER.DIR_WS_ADMIN;
if ($link == "HTTPS_CATALOG_SERVERDIR_WS_ADMIN")
{
...
define('MODULE_SHIPPING_SEDEXLOCAL_TEXT_TITLE', 'SEDEX                                       <img src="'.$link.'images/entrega_sedex.gif" width="43" height="23" align="absmiddle">');

define('MODULE_SHIPPING_SEDEXLOCAL_TEXT_DESCRIPTION', 'SEDEX');
define('MODULE_SHIPPING_SEDEXLOCAL_TEXT_ERRO', 'Erro no cálculo do frete ou modalidade não disponível para este local!<br> <a href=contact_us.php>Clique aqui</a> para contactar a Administração e informar sobre este erro');
define('MODULE_SHIPPING_SEDEXLOCAL_TEXT_PESO', 'Peso-base para cálculo');
define('MODULE_SHIPPING_SEDEXLOCAL_TEXT_PRAZO', 'Prazo para entrega: 1 a 4 dias úteis');
?>