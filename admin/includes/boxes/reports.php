...
<?php
  ...
  if ($selected_box == 'reports') {
    $contents[] = array('text'  => '<a href="' . tep_href_link(FILENAME_STATS_PRODUCTS_VIEWED, '', 'NONSSL') . '" class="menuBoxContentLink">' . BOX_REPORTS_PRODUCTS_VIEWED . '</a><br>' .
    							   ...
    							   '<a href="' . tep_href_link(FILENAME_STATS_DETAILED_MONTHLY_SALES, '', 'NONSSL') . '" class="menuBoxContentLink">' . BOX_REPORTS_DETAILED_MONTHLY_SALES . '</a><br>' .
								   '<a href="' . tep_href_link(FILENAME_WHOS_ONLINE, '', 'NONSSL') . '" class="menuBoxContentLink">' . BOX_REPORTS_WHOS_ONLINE . '</a>');
  }
  $box = new box;
