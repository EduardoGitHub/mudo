...
define('MODULE_SHIPPING_SEDEX10LOCAL_TEXT_TITLE', 'Sedex 10                                  <img src="'.$link.'images/entrega_sedex10.gif" width="43" height="23" align="absmiddle">'); 

define('MODULE_SHIPPING_SEDEX10LOCAL_TEXT_DESCRIPTION', 'SEDEX 10');
define('MODULE_SHIPPING_SEDEX10LOCAL_TEXT_ERRO', 'Erro no cálculo do frete ou modalidade não disponível para este local!<br> <a href=contact_us.php>Clique aqui</a> para contactar a Administração e informar sobre este erro');
define('MODULE_SHIPPING_SEDEX10LOCAL_TEXT_PESO', 'Peso-base para cálculo');
define('MODULE_SHIPPING_SEDEX10LOCAL_TEXT_PRAZO', 'Até 10hs da manhã do dia útil seguinte ao da postagem');
?>