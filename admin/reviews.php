	 ...
	 case 'setflag':
        ...
        if ( ($HTTP_GET_VARS['flag'] == '0') || ($HTTP_GET_VARS['flag'] == '1') ) {
          if (isset($HTTP_GET_VARS['rID'])) {
            tep_set_reviews_status($reviews_id, $HTTP_GET_VARS['flag']);
          }
        }
    ...
    <td width="100%" valign="top" id="main"><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo HEADING_TITLE; //.HTTP_CATALOG_SERVER . DIR_WS_CATALOG_IMAGES; ?></td>
      ...
      <tr><?php echo tep_draw_form('review', FILENAME_REVIEWS, 'page=' . $HTTP_GET_VARS['page'] . '&rID=' . $HTTP_GET_VARS['rID'] . '&action=preview'); ?>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td class="main" align="right" valign="top"><?php echo tep_image_produto('../'.DIR_WS_IMAGES_PRODUTOS.$rInfo->products_image, $rInfo->products_name, 'YES','P', 'vspace="0"'); ?>
            </td>
          </tr>
        </table></td>
      </tr>
...
?>
      <tr><?php echo tep_draw_form('update', FILENAME_REVIEWS, 'page=' . $HTTP_GET_VARS['page'] . '&rID=' . $HTTP_GET_VARS['rID'] . '&action=update', 'post', 'enctype="multipart/form-data"'); ?>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="main" valign="top"><b><?php echo ENTRY_PRODUCT; ?></b> <?php echo $rInfo->products_name; ?><br><b><?php echo ENTRY_FROM; ?></b> <?php echo $rInfo->customers_name; ?><br><br><b><?php echo ENTRY_DATE; ?></b> <?php echo tep_date_short($rInfo->date_added); ?></td>
            <td class="main" align="right" valign="top"><?php echo tep_image_produto('../'.DIR_WS_IMAGES_PRODUTOS.$rInfo->products_image, $rInfo->products_name, 'YES','P', 'vspace="0"'); ?></td>
          </tr>
        </table>
      </tr>
      <tr>
      ...
      <tr>
        <td class="main"><b><?php echo ENTRY_RATING; ?></b>&nbsp;<?php echo tep_image('../'.DIR_WS_IMAGES . 'stars_' . $rInfo->reviews_rating . '.gif', sprintf(TEXT_OF_5_STARS, $rInfo->reviews_rating)); ?>&nbsp;<small>[<?php echo sprintf(TEXT_OF_5_STARS, $rInfo->reviews_rating); ?>]</small></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
      </tr>
...
<?php
    $reviews_query_raw = "select reviews_id, products_id, status, date_added, last_modified, reviews_rating from " . TABLE_REVIEWS . " order by date_added DESC";
...
?>
                ...
                <td class="dataTableContent" align="right"><?php echo tep_image('../'.DIR_WS_IMAGES . 'stars_' . $reviews['reviews_rating'] . '.gif'); ?></td>
...
<?php
    ...
    switch ($action) {
      ...
      if (isset($rInfo) && is_object($rInfo)) {
        ...
        $contents[] = array('text' => '<br>' . tep_image_produto('../'.DIR_WS_IMAGES_PRODUTOS.$rInfo->products_image, $rInfo->products_name, 'YES','P', 'vspace="0"'));
        $contents[] = array('text' => '<br>' . TEXT_INFO_REVIEW_AUTHOR . ' ' . $rInfo->customers_name);
        $contents[] = array('text' => TEXT_INFO_REVIEW_RATING . ' ' . tep_image('../'.DIR_WS_IMAGES . 'stars_' . $rInfo->reviews_rating . '.gif'));
