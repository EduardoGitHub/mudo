<?php
  ...
  $error = false;
	...
	$type = tep_db_prepare_input($_POST['tipo']);
	$telephone = tep_db_prepare_input($_POST['telefone']);
    $email_address = tep_db_prepare_input($_POST['email']);
	$email_address_confirmation = tep_db_prepare_input($_POST['email_confirmation']);
    $enquiry = tep_db_prepare_input($_POST['enquiry']);
	$city = tep_db_prepare_input($_POST['cidade']);
	$state = tep_db_prepare_input($_POST['estado']);
	$arquivos = tep_db_prepare_input($_POST['arquivos']);
