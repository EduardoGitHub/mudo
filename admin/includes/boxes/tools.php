...
<?php
  ...
  $heading[] = array('text'  => BOX_HEADING_TOOLS,
                     'link'  => tep_href_link(FILENAME_BANNER_MANAGER, 'selected_box=tools'));
  ...
  if ($selected_box == 'tools') {
    $contents[] = array('text'  => //'<a href="' . tep_href_link(FILENAME_BACKUP) . '" class="menuBoxContentLink">' . BOX_TOOLS_BACKUP . '</a><br>' .
								   ...
								   '<a href="' . tep_href_link(FILENAME_PARTNERS) . '" class="menuBoxContentLink">' . BOX_TOOLS_PARTNERS . '</a><br>' .
								   '<a href="' . tep_href_link(FILENAME_GALLERY) . '" class="menuBoxContentLink">' . BOX_TOOLS_GALLERY . '</a><br>' .
								   ...
								   '<a href="' . tep_href_link(FILENAME_NEWSLETTER) . '" class="menuBoxContentLink">' . BOX_TOOLS_NEWSLETTER_EMAILS . '</a><br>' .
								   ...
								   '<a href="' . tep_href_link(FILENAME_LIST_PRICE) . '" class="menuBoxContentLink">' . BOX_TOOLS_UPLOAD_LIST_PRICE . '</a><br>'.
								   '<a href="' . tep_href_link('sitemap.php') . '" class="menuBoxContentLink">Google - SiteMap</a><br>'.
								   '<a href="' . tep_href_link(FILENAME_EXPORT_DADOS) . '" class="menuBoxContentLink">' . BOX_TOOLS_EXPORT_DATA . '</a>');
  }
