...
?>
                ...
                <tr><td><?php echo tep_image_submit('button_confirm.gif','TEXT_CONTINUE'); ?></td></tr>
                <form>
<?php
                $nolink = true;
                break;
...
?>
      <tr>
        <td align="right" class="main"><br><?php echo '<a href="' . tep_href_link(FILENAME_POLLS, '', 'NONSSL') . '">' . tep_image_button('button_confirm.gif', 'CONTINUE') . '</a>'; ?></td>
      </tr>
<?php
}
?>
