      ...
      <tr>
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <!--<td class="specialPrice" align="right">NOTICE: <a href=<?=tep_href_link( DIR_WS_LANGUAGES.$language.'/'.FILENAME_DISCOUNT_COUPONS_MANUAL )?>> <?= HEADING_TITLE_VIEW_MANUAL ?></a></td> -->
          </tr>
        </table></td>
      </tr>
<?php
...
<?php
    $coupons_query_raw = "select * from " . TABLE_DISCOUNT_COUPONS . " cd order by coupons_description, cd.coupons_date_end, coupons_date_start";
