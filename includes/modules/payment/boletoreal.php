...
// | 																					  |
// | ADAPTADO-BOLETOREAL PARA OSCOMMERCE: Welliton Cordeiro (Pinga_oz) - www.airgun.com.br |
...
// class constructor
    function boletoreal() {
      ...
      $this->code = 'boletoreal';
      $this->title = MODULE_PAYMENT_BOLETOREAL_TEXT_TITLE;
	  $this->revenda = MODULE_PAYMENT_BOLETOREAL_TEXT_ENABLE_REVENDA;
	  $this->normaluser = MODULE_PAYMENT_BOLETOREAL_TEXT_ENABLE_USERFINAL;
      $this->description = MODULE_PAYMENT_BOLETOREAL_TEXT_DESCRIPTION;
      $this->sort_order = MODULE_PAYMENT_BOLETOREAL_SORT_ORDER;
      $this->enabled = ((MODULE_PAYMENT_BOLETOREAL_STATUS == 'True') ? true : false);

      if ((int)MODULE_PAYMENT_BOLETOREAL_ORDER_STATUS_ID > 0) {
        $this->order_status = MODULE_PAYMENT_BOLETOREAL_ORDER_STATUS_ID;
      }
...
// class methods
    function update_status() {
      ...
      if ( ($this->enabled == true) && ((int)MODULE_PAYMENT_BOLETOREAL_ZONE > 0) ) {
        $check_flag = false;
        $check_query = tep_db_query("select zone_id from " . TABLE_ZONES_TO_GEO_ZONES . " where geo_zone_id = '" . MODULE_PAYMENT_BOLETOREAL_ZONE . "' and zone_country_id = '" . $order->billing['country']['id'] . "' order by zone_id");
...
$n_pedido = $res_pedido['orders_id'] + 1;
    ...
    function check() {
      if (!isset($this->_check)) {
        $check_query = tep_db_query("select configuration_value from " . TABLE_CONFIGURATION . " where configuration_key = 'MODULE_PAYMENT_BOLETOREAL_STATUS'");
    ...
    function install() {
	  ...
	  tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   ") values (".
                   "'Gerar Boletos Bancário - Itaú', 'MODULE_PAYMENT_BOLETOREAL_STATUS', 'True', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'URL do arquivo de geração do boleto.', 'MODULE_PAYMENT_BOLETOREAL_URL', '" . HTTPS_CATALOG_SERVER . "boletos/real/boleto_real.php', ".
                   "'Informar a URL do arquivo de geração do BOLETOREAL referente ao seu banco.<br>Ex.(boleto/boleto_itau.php)', '6', '2', ".
                   "now())");
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Local de Pagamento', 'MODULE_PAYMENT_BOLETOREAL_LOCALPAGAMENTO', '', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Agencia Bancária', 'MODULE_PAYMENT_BOLETOREAL_AGENCIA', '', ".
	  ...
	  tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Conta Corrente', 'MODULE_PAYMENT_BOLETOREAL_CONTA', '', ".
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Conta Corrente DV', 'MODULE_PAYMENT_BOLETOREAL_CONTADV', '', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Carteira', 'MODULE_PAYMENT_BOLETOREAL_CARTEIRA', '', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'CNPJ', 'MODULE_PAYMENT_BOLETOREAL_CNPJ', '', ".
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Endereço', 'MODULE_PAYMENT_BOLETOREAL_ENDERECO', '', ".
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Cidade', 'MODULE_PAYMENT_BOLETOREAL_CIDADE', '', ".
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Cedente', 'MODULE_PAYMENT_BOLETOREAL_CEDENTE', '', ".
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Prazo de Vencimento', 'MODULE_PAYMENT_BOLETOREAL_PRAZOVENCIMENTO', '1', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Demonstrativo', 'MODULE_PAYMENT_BOLETOREAL_DEMONSTRATIVO', '', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Instruções', 'MODULE_PAYMENT_BOLETOREAL_INSTRUCOES', '', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Instruções', 'MODULE_PAYMENT_BOLETOREAL_INSTRUCOES1', '', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Instruções', 'MODULE_PAYMENT_BOLETOREAL_INSTRUCOES2', '', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Instruções', 'MODULE_PAYMENT_BOLETOREAL_INSTRUCOES3', '', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   ") values (".
                   "'Zonas suportadas', 'MODULE_PAYMENT_BOLETOREAL_ZONE', '0', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "use_function, set_function, date_added".
                   ") values (".
                   "'Status dos pedidos', 'MODULE_PAYMENT_BOLETOREAL_ORDER_STATUS_ID', '1', ".
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Ordem de exibição', 'MODULE_PAYMENT_BOLETOREAL_SORT_ORDER', '0', ".
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "set_function, date_added".
                   ") values (".
                   "'Habilitar módulo de pagamento para usuário revendedor', 'MODULE_PAYMENT_BOLETOREAL_TEXT_ENABLE_REVENDA', 'True', ".
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "set_function, date_added".
                   ") values (".
                   "'Habilitar módulo de pagamento para usuário normal', 'MODULE_PAYMENT_BOLETOREAL_TEXT_ENABLE_USERFINAL', 'True', ".
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (".
                   ...
                   "date_added".
                   ") values (".
                   "'Nosso número', 'MODULE_PAYMENT_BOLETOREAL_FX_INICIAL', '', ".
    ...
    function keys() {
      ...
      return array('MODULE_PAYMENT_BOLETOREAL_STATUS', 'MODULE_PAYMENT_BOLETOREAL_CEDENTE', 'MODULE_PAYMENT_BOLETOREAL_PRAZOVENCIMENTO', 'MODULE_PAYMENT_BOLETOREAL_CNPJ', 'MODULE_PAYMENT_BOLETOREAL_ENDERECO',
	  			   'MODULE_PAYMENT_BOLETOREAL_CIDADE', 'MODULE_PAYMENT_BOLETOREAL_URL', 'MODULE_PAYMENT_BOLETOREAL_LOCALPAGAMENTO', 'MODULE_PAYMENT_BOLETOREAL_AGENCIA',
				   'MODULE_PAYMENT_BOLETOREAL_CONTA', 'MODULE_PAYMENT_BOLETOREAL_CONTADV','MODULE_PAYMENT_BOLETOREAL_CARTEIRA', 'MODULE_PAYMENT_BOLETOREAL_DEMONSTRATIVO', 'MODULE_PAYMENT_BOLETOREAL_INSTRUCOES', 'MODULE_PAYMENT_BOLETOREAL_INSTRUCOES1', 'MODULE_PAYMENT_BOLETOREAL_FX_INICIAL',
				   'MODULE_PAYMENT_BOLETOREAL_INSTRUCOES2', 'MODULE_PAYMENT_BOLETOREAL_INSTRUCOES3','MODULE_PAYMENT_BOLETOREAL_ZONE',
				   'MODULE_PAYMENT_BOLETOREAL_ORDER_STATUS_ID', 'MODULE_PAYMENT_BOLETOREAL_TEXT_ENABLE_REVENDA','MODULE_PAYMENT_BOLETOREAL_TEXT_ENABLE_USERFINAL','MODULE_PAYMENT_BOLETOREAL_SORT_ORDER');
