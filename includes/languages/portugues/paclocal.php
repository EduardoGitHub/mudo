...
Última edição 26/04/2009 por  www.legalloja.com.br (Valmy Gomes)
  pac.php 26/04/2009
  Módulo de Frete PAC para osCommerce 
...
define('MODULE_SHIPPING_PACLOCAL_TEXT_TITLE', 'PAC 
	    <img src="'.$link.'images/entrega_pac.gif" width="43" height="23" align="absmiddle">');

define('MODULE_SHIPPING_PACLOCAL_TEXT_DESCRIPTION', 'PAC');
define('MODULE_SHIPPING_PACLOCAL_TEXT_ERRO', 'Erro no cálculo do frete ou modalidade não disponível para este local!<br> <a href=contact_us.php>Clique aqui</a> para contactar a Administração e informar sobre este erro');
define('MODULE_SHIPPING_PACLOCAL_TEXT_PESO', 'Peso-base para cálculo');
define('MODULE_SHIPPING_PACLOCAL_TEXT_PRAZO', 'Prazo para entrega: 3 a 12 dias úteis');
?>