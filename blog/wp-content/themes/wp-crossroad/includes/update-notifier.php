...
define( 'NOTIFIER_THEME_NAME', 'CrossRoad' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'wp-crossroad' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://color-theme.com/tools/notifier/crossroad/notifier.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
